...
1. [功能](#功能)
1. [安装前准备](#安装前准备)
    1. [安装Java 8以上版本](#安装Java 8以上版本)
    1. [安装Scala 2.11以上版本](#安装Scala 2.11以上版本)
    1. [安装SBT 0.13以上版本](#安装SBT 0.13以上版本)
    1. [安装NodeJS 5以上版本](#安装NodeJS 5以上版本)
    1. [安装MongoDB 3以上版本](#安装MongoDB 3以上版本)
1. [运行](#运行)
    1. [获取源代码](#获取源代码)
